...
const CuciMobilCirebon = () => {
  ...
  const carWashSteps = [
    {
      title: "Mobil Masuk",
      description: "Pemeriksaan kondisi awal kendaraan",
      icon: "🚗",
      step: 1,
    },
    {
      title: "Naik Hidrolik",
      description: "Akses menyeluruh ke seluruh bagian",
      icon: "⬆️",
      step: 2,
    },
    {
      title: "Snow Foam",
      description: "Angkat kotoran tanpa merusak cat",
      icon: "❄️",
      step: 3,
    },
    {
      title: "Hand Wash",
      description: "Pembersihan manual dengan microfiber",
      icon: "🧽",
      step: 4,
    },
    {
      title: "Pembilasan",
      description: "Air PDAM berkualitas premium",
      icon: "💦",
      step: 5,
    },
    {
      title: "Interior Clean",
      description: "Vakum dan poles dashboard",
      icon: "🧹",
      step: 6,
    },
    {
      title: "Pengeringan",
      description: "Hasil sempurna tanpa bekas air",
      icon: "✨",
      step: 7,
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Layanan cuci menyeluruh dengan perhatian pada setiap detail",
      icon: Droplets,
      features: [
        "Exterior wash",
        "Interior vacuum",
    ...
    },
    {
      ...
      description:
        "Perbaikan dan perawatan sistem AC oleh teknisi berpengalaman",
      icon: Sparkles,
      features: [
        "Isi freon",
        "Perbaikan kompresor",
  ...
  const faqs = [
    {
      question: "Dimana tempat cuci mobil terbaik di Cirebon?",
      answer:
        "Jakarta Int'l Denso Cirebon adalah tempat cuci mobil terpercaya di Jl. Garuda No 2, Cirebon, Jawa Barat, beroperasi sejak 2004 dengan fasilitas hidrolik modern, air PDAM berkualitas, dan rating 4.9/5 dari 160+ pelanggan. Buka setiap hari 08.00-17.00 WIB.",
    },
    {
      question: "Berapa harga cuci mobil di Jakarta Int'l Denso Cirebon?",
      answer:
        "Harga cuci mobil mulai dari Rp35.000 untuk cuci luar dan Rp55.000 untuk cuci luar dalam. Harga dapat bervariasi tergantung jenis dan ukuran mobil. Tersedia juga paket bulanan dengan harga lebih hemat.",
    },
    {
      question: "Berapa lama waktu cuci mobil?",
      answer:
        "Waktu cuci mobil berkisar 30-60 menit tergantung paket yang dipilih. Cuci luar sekitar 30 menit, cuci luar dalam sekitar 45-60 menit. Kami mengutamakan kualitas hasil cuci.",
    },
    {
      question: "Apa keunggulan cuci mobil di Jakarta Int'l Denso?",
      answer:
        "Keunggulan kami meliputi: (1) Pengalaman 20+ tahun sejak 2004, (2) Teknisi profesional terlatih, (3) Hidrolik modern untuk akses menyeluruh, (4) Air PDAM berkualitas, (5) Produk pembersih premium, (6) Ruang tunggu nyaman dengan WiFi gratis.",
    },
    {
      question: "Apakah buka setiap hari?",
      answer:
        "Ya, kami buka setiap hari Senin-Minggu mulai pukul 08.00-17.00 WIB. Kami juga beroperasi di hari libur nasional.",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-cyan-300 text-sm font-medium">
                Pionir Cuci Mobil Cirebon Sejak 2004
              </span>
            </motion.div>
            ...
            >
              Percayakan perawatan mobil Anda kepada teknisi profesional dengan
              pengalaman 20+ tahun. Hasil bersih maksimal, fasilitas modern,
              harga terjangkau.
            </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Sejak 2004, <strong>Jakarta Intl Denso Cirebon</strong> telah
                menjadi nama yang dipercaya dalam industri perawatan kendaraan
                di Cirebon. Kami menggunakan teknologi modern dan produk
                berkualitas.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Fasilitas hidrolik modern, air PDAM berkualitas, dan ruang
                tunggu nyaman dengan WiFi gratis – semuanya untuk kenyamanan
                Anda.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  "Servis AC mobil oleh spesialis",
                  "Garansi kepuasan 100%",
                  "Fasilitas tunggu nyaman",
                ].map((item, index) => (
                  <div
                    key={index}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              7 Langkah Cuci Mobil{" "}
              <span className="text-cyan-600">Premium</span>
            </h2>
      ...
      <section className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Jawaban seputar cuci mobil di Cirebon
            </p>
          </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <summary className="flex items-center justify-between gap-4 cursor-pointer list-none font-bold text-gray-900">
                  ...
                  <span className="text-cyan-600 transition-transform duration-300 group-open:rotate-45 text-2xl leading-none">
                    +
                  </span>
                </summary>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap Mencoba Layanan{" "}
              <span className="text-[#ed3f36]">Terbaik</span> Kami?
            </h2>
            <p className="text-xl text-blue-100/80 mb-10">
              Dapatkan pengalaman cuci mobil premium di Jakarta Intl Denso
              Cirebon!
            </p>
            <button
              onClick={() =>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Bengkel AC mobil & tune up mesin terpercaya
              </p>
            </Link>
            <Link
              href="/harga"
