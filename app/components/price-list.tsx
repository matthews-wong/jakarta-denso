...
const priceCategories: PriceCategory[] = [
  {
    ...
    description:
      "Layanan cuci mobil terbaik di Cirebon dengan teknologi modern dan peralatan premium",
    items: [
      {
        name: "Cuci Motor Salju",
        price: "Rp 25.000",
        description:
          "Teknologi snow wash premium untuk motor. Pembersihan menyeluruh dengan foam berkualitas tinggi.",
        keywords: [
          "cuci motor cirebon",
          "snow wash cirebon",
          "cuci motor snow wash",
        ],
      },
      {
        ...
        price: "Rp 55.000",
        description:
          "Snow wash teknologi terbaru untuk mobil. Aman untuk semua jenis cat mobil dengan hasil maksimal.",
        keywords: [
          "cuci mobil cirebon",
          "snow wash mobil",
          "bengkel cuci mobil",
      ...
      },
      {
        ...
        price: "Rp 60.000",
        description:
          "Premium wash dengan pilihan wangi eksklusif. Termasuk shampoo mobil premium dan wax pelindung.",
        keywords: [
      ...
      },
      {
        ...
        price: "Rp 200.000",
        description:
          "Coating wetlook premium dengan hasil mengkilap tahan lama. Garansi hasil dan konsultasi gratis.",
        keywords: [
      ...
      },
      {
        ...
        price: "Rp 20.000",
        description:
          "Perawatan profesional untuk karet dan pintu mobil menggunakan silikon T6 premium.",
        keywords: [
          "doorsmeer cirebon",
  ...
  },
  {
    ...
    description:
      "Jasa salon dan poles kendaraan profesional di Cirebon dengan teknisi berpengalaman",
    items: [
      {
        name: "Poles Motor",
        price: "Rp 50.000",
        description:
          "Poles motor profesional dengan pengalaman 10+ tahun. Compound premium untuk hasil mengkilap maksimal.",
        keywords: [
          "poles motor cirebon",
          "salon motor cirebon",
          "bengkel motor cirebon",
        ],
      },
      {
        ...
        price: "Rp 150.000",
        description:
          "Treatment khusus jamur kaca dengan nano coating. Menghilangkan jamur dan bercak membandel permanen.",
        keywords: [
          "poles kaca mobil cirebon",
          "treatment jamur kaca",
          "nano coating cirebon",
        ],
        popular: true,
      },
      {
        ...
        price: "Rp 250.000",
        description:
          "Layanan khusus menghilangkan baret wiper dengan teknik poles presisi dan bahan premium.",
        keywords: [
          "poles baret wiper",
          "treatment kaca mobil",
          "poles kaca cirebon",
        ],
      },
      {
        ...
        description:
          "Poles body profesional dengan compound import. Hasil premium dengan garansi dan konsultasi gratis.",
        keywords: [
          "poles mobil cirebon",
          "salon mobil cirebon",
          "detailing mobil",
      ...
      },
      {
        ...
        price: "Mulai Rp 400.000",
        description:
          "Pembersihan interior menyeluruh dengan produk khusus dan teknik detailing profesional.",
        keywords: [
      ...
      },
      {
        ...
        price: "Rp 860.000",
        description:
          "Paket hemat all-in-one! Satu harga sudah termasuk 6 layanan sekaligus untuk mobil kinclong luar-dalam. Jauh lebih hemat dibanding ambil terpisah.",
        keywords: [
          "salon mobil komplit",
          "detailing mobil full",
          "paket salon mobil",
        ],
        popular: true,
        includes: [
  ...
  },
  {
    ...
    description:
      "Bengkel specialist AC mobil terpercaya di Cirebon dengan teknisi berpengalaman",
    items: [
      {
        name: "Service AC Mobil",
        price: "Rp 600.000",
        description:
          "Service AC lengkap oleh teknisi berpengalaman. Mengatasi AC tidak dingin, bocor, dan berisik.",
        keywords: [
      ...
      },
      {
        ...
        price: "Rp 350.000",
        description:
          "Isi freon AC berkualitas R134a dan R1234yf. Pengisian presisi dengan alat digital dan garansi dingin.",
      ...
      },
      {
        ...
        description:
          "Perbaikan AC mobil untuk kerusakan kompleks. Teknisi ahli dengan peralatan modern dan spare part original.",
        keywords: [
          "service ac mobil cirebon",
          "bengkel ac terdekat",
          "perbaikan ac mobil",
  ...
  },
  {
    ...
    description:
      "Layanan perawatan dan perbaikan mesin mobil oleh teknisi ahli di Cirebon",
    items: [
      {
        name: "Isi Gas Nitrogen",
        price: "Rp 10.000/Ban",
        description:
          "Pengisian gas nitrogen untuk performa dan umur ban optimal. Menghemat BBM dengan teknologi presisi.",
      ...
      },
      {
        ...
        price: "Rp 15.000",
        description:
          "Pengisian aki mobil dengan charger modern. Perpanjang umur aki dengan cek kondisi gratis.",
      ...
      },
      {
        ...
        price: "Rp 25.000",
        description:
          "Tambal ban tubeless profesional dengan material berkualitas tinggi. Proses cepat dan garansi tidak bocor.",
        keywords: [
          "tambal ban tubeless",
          "service ban cirebon",
          "bengkel ban 24 jam",
      ...
      },
      {
        ...
        description:
          "Pembersihan sistem bahan bakar diesel untuk performa optimal dan konsumsi BBM efisien.",
        keywords: [
          "purging diesel cirebon",
          "service mesin diesel",
      ...
      {item.includes && item.includes.length > 0 && (
        <div className="mb-6 rounded-xl border border-gray-100 bg-gray-50/80 p-4">
          <p className="mb-3 text-xs font-bold uppercase tracking-wide text-gray-700">
            Sudah termasuk {item.includes.length} layanan:
          </p>
          <ul className="grid grid-cols-1 gap-x-3 gap-y-2 sm:grid-cols-2">
...
const CategorySection: React.FC<{ category: PriceCategory; index: number }> = ({
  category,
  index,
}) => (
  <motion.section
  ...
  >
    ...
    <div className="text-center mb-12">
      <div className="flex items-center justify-center gap-4 mb-6">
        <div
          className={`text-4xl p-4 bg-gradient-to-r ${category.color} rounded-2xl shadow-lg`}
        >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
            <span className="font-bold text-[#27398f]">
              Layanan automotive terlengkap di Cirebon
            </span>{" "}
            dengan harga transparan, kualitas terjamin, dan teknisi
            berpengalaman 20+ tahun. Dari cuci mobil, salon, service AC hingga
            perbaikan mesin.
          </p>
        ...
        >
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-12 shadow-2xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Dapatkan layanan terbaik untuk kendaraan Anda dengan harga
              transparan dan kualitas terjamin. Konsultasi gratis sebelum
              service!
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="flex flex-col items-center text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Semua layanan dilengkapi garansi resmi untuk kepuasan maksimal
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Tim teknisi ahli dengan pengalaman 20+ tahun di bidang
                automotive
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Tidak ada biaya tersembunyi, semua harga sudah final dan
                terjangkau
              </p>
            </div>
          </div>
          ...
          <div className="text-center text-gray-600 space-y-2 pt-8">
            <p className="text-sm">
              <strong className="text-[#27398f]">
                Bengkel Mobil Cirebon Terpercaya
              </strong>{" "}
              - Melayani Kota Cirebon dan sekitarnya
            </p>
            <p className="text-sm">
