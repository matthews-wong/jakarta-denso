...
const galleryImages = [
  {
    ...
    popular: true,
    description:
      "Snow wash premium dengan teknologi terdepan untuk hasil bersih maksimal",
  },
  {
  ...
  },
  {
    ...
    description:
      "Fasilitas bengkel modern dengan peralatan canggih dan teknisi ahli",
  },
];
...
const jsonLd = {
  ...
  description:
    "Galeri hasil kerja profesional Jakarta Intl Denso, bengkel AC mobil terpercaya di Cirebon",
        ...
        >
          <div className="flex items-center justify-between max-w-6xl mx-auto">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white/60 text-sm">{image.category}</div>
            </div>
          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Lihat berbagai hasil kerja profesional kami dengan kualitas
                terbaik di Cirebon.
              </p>
            </div>
          ...
          >
            <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-12 shadow-2xl">
              ...
              <p className="text-xl text-gray-300 mb-4 leading-relaxed">
                <strong>Jakarta Intl Denso</strong> siap memberikan solusi
                terbaik untuk semua kebutuhan kendaraan Anda!
              </p>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                ⭐ <strong>AC Mobil Tidak Dingin?</strong> Tim teknisi
                berpengalaman kami siap service dengan spare part original
                <br />⭐ <strong>Mobil Kotor & Kusam?</strong> Nikmati layanan
                cuci & salon mobil premium dengan hasil seperti mobil baru
                <br />⭐ <strong>Butuh Aksesoris Berkualitas?</strong> Tersedia
                cover jok, parfum mobil, velg, dan aksesoris lainnya
                <br />⭐ <strong>Lokasi Strategis di Cirebon</strong> - Mudah
                dijangkau dengan parkir luas & nyaman
              </p>
